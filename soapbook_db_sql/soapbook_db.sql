...
CREATE TABLE `recipes` (
  ...
  `ingredient_amt` float DEFAULT NULL,
...
INSERT INTO `recipes` VALUES (2,3,10,1.8,1),(3,3,4,9,1),(4,3,5,14.4,1),(5,3,3,9,1),(6,3,23,1.8,1),(7,3,2,5.1,1),(8,3,1,10.1,1),(9,3,24,1.7,1),(10,3,15,2,4),(11,4,28,3.2,1),(12,4,10,1.2,1),(13,4,4,10,1),(14,4,5,17.6,1),(15,4,3,8,1),(16,4,2,5.6,1),(17,4,1,11.9,1),(18,4,29,2,1),(19,4,16,NULL,NULL),(20,4,30,NULL,NULL),(21,4,31,NULL,NULL);
...
INSERT INTO `soaps` VALUES (1,'Lavender and Honey','This soap has the wonderful sweetness of honey, and the relaxing scent of lavender'),(2,'Orange and Vanilla','This soap combines the essential oils of orange and vanilla to create the scent of an orange creamsicle'),(3,'Charcoal and tea tree','These charcoal facial bars are great for oily, or blemish prone skin.'),(4,'Jade','The jade stone is known for its beautiful green color and the thought that it has healing properties. The stone inspired our Jade Fragrance Oil, which is a fresh and green floral scent. It has notes of English ivy, jasmine, green apple, and neroli. The wispy swirls in these jade bars are created by pouring the green and white soap into the mold, then swirling them together with the Hanger Swirl Tool.');
...
INSERT INTO `units` VALUES (1,'oz','ounce'),(2,'lb','pound'),(3,'tsp','teaspoon'),(4,'Tbsp','tablespoon'),(5,'c','cup'),(6,'gal','gallon'),(7,'g','gram');
...
-- Dump completed on 2017-12-03 17:54:11
